...
\begin{frame}{\insertsection}
	\begin{columns}
		\column{.3\textwidth}
		\centering
		\textcolor{fsiblue}{\includegraphics[width=4.5cm]{pictures/qr-gruppe-info.png}
			\\[1em]
			\text{*-Informatik}}
		...
		\column{.3\textwidth}
		\centering
		\textcolor{fskgreen}{\includegraphics[width=4.5cm]{pictures/qr-gruppe-kogni.png}
			\\[1em]
			\text{Kognitionswissenschaft}}
			% \url{https://chat.whatsapp.com/Iji6OXe67vI1E5a58oh39D}}
