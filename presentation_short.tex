...
% 	\begin{columns}
% 		\column{.3\textwidth}
% 		\textcolor{fsiblue}{\qrcode[height=.5\textheight]{}
% 			\\[1em]
% 			\url{}}

% 		\column{.4\textwidth}
% 		\centering
% 		\includegraphics[height=0.8\textheight]{pictures/fsi_ducky.pdf}

% 		\column{.3\textwidth}
% 		\centering
% 		\textcolor{fskgreen}{\qrcode[height=.5\textheight]{}
% 			\\[1em]
% 			\url{}}
